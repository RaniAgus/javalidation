 ...
 * <ul>
 *   <li>Chain more results with {@link #and(Result)} (returns ResultCombiner7)</li>
 *   <li>Terminate with {@link #combine(HexFunction<T1, T2, T3, T4, T5, T6, R>)} to produce the final result</li>
 * </ul>
 * <p>
 ...
 *
 * @param <T1> <T2> <T3> <T4> <T5> <T6>> the types of the results' success values
