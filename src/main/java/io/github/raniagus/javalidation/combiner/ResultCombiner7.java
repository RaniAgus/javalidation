...
/**
 * Combines 7 {@link Result}s using the applicative functor pattern.
 * <p>
 ...
 * <ul>
 *   <li>Chain more results with {@link #and(Result)} (returns ResultCombiner8)</li>
 *   <li>Terminate with {@link #combine(SeptaFunction<T1, T2, T3, T4, T5, T6, T7, R>)} to produce the final result</li>
 * </ul>
 * <p>
 ...
 *     .combine((v1, v2, v3, v4, v5, v6, v7) -> new Person(v1, v2, v3, v4, v5, v6, v7));
 * }</pre>
 * <p>
 * If any validation fails, all errors are accumulated in the final {@code Err} result.
 *
 * @param <T1> <T2> <T3> <T4> <T5> <T6> <T7>> the types of the results' success values
...
public record ResultCombiner7<T1 extends @Nullable Object, T2 extends @Nullable Object, T3 extends @Nullable Object, T4 extends @Nullable Object, T5 extends @Nullable Object, T6 extends @Nullable Object, T7 extends @Nullable Object>(
     ...
     *     // ... more .and() calls
     *     .and(result8)
     *     .combine((v1, v2, v3, v4, v5, v6, v7, v8) -> new Combined(v1, v2, v3, v4, v5, v6, v7, v8));
     * }</pre>
     *
     * @param result8 the next result to combine
     ...
     * Example:
     * <pre>{@code
     * Result<Combined> result = combiner.combine((v1, v2, v3, v4, v5, v6, v7) ->
     *     new Combined(v1, v2, v3, v4, v5, v6, v7)
     * );
     * }</pre>
     *
