...
public class NonaFor<A, B, C, D, E, F, G, H, I> {
  ...
  public NonaFor(Result<A> result1, Result<B> result2, Result<C> result3, Result<D> result4, Result<E> result5, Result<F> result6, Result<G> result7, Result<H> result8, Result<I> result9) {
  ...
  public <R> Result<R> with(io.github.raniagus.javalidation.function.NonaFunction<A, B, C, D, E, F, G, H, I, R> onSuccess) {
    return Result.merge(
