...
public class HexFor<A, B, C, D, E, F> {
  ...
  public HexFor(Result<A> result1, Result<B> result2, Result<C> result3, Result<D> result4, Result<E> result5, Result<F> result6) {
  ...
  public <R> Result<R> with(HexFunction<A, B, C, D, E, F, R> onSuccess) {
    return Result.merge(
