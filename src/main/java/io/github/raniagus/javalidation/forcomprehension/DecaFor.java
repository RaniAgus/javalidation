...
public class DecaFor<A, B, C, D, E, F, G, H, I, J> {
  ...
  public DecaFor(Result<A> result1, Result<B> result2, Result<C> result3, Result<D> result4, Result<E> result5, Result<F> result6, Result<G> result7, Result<H> result8, Result<I> result9, Result<J> result10) {
  ...
  public <R> Result<R> with(DecaFunction<A, B, C, D, E, F, G, H, I, J, R> onSuccess) {
    return Result.merge(
