...
class ValidateAnnotationTest {
    ...
    class CompilationTests {
        ...
        @Test
        void givenNonRecordType_whenProcessingWithValid_thenGeneratesWarning() {
        ...
        @Test
        void givenRecordWithNoConstraints_whenProcessingWithValid_thenGeneratesEmptyValidator() {
        ...
        @Test
        void givenRecordWithValidField_whenProcessing_thenGeneratesValidatorWithInitialization() {
            // Arrange - create source files in memory
        ...
        @Test
        void givenRecordWithNestedRecord_whenProcessing_thenGeneratesValidatorsForBothRecords() {
            // Arrange - create source files in memory
        ...
        @Test
        void givenRecordWithCyclicValidReference_whenProcessing_thenGeneratesValidatorsWithMutualInitialization() {
            // Arrange - create source files in memory
            JavaFileObject sourceFile = JavaFileObjects.forSourceString("test.UserRequest", """
                    package test;
        ...
        @Test
        void givenSealedInterfaceWithRecordPermits_whenProcessing_thenGeneratesDelegatingValidator() {
