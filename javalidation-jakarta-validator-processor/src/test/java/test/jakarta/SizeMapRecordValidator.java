...
public class SizeMapRecordValidator implements InitializableValidator<SizeMapRecord> {
    private static final Constraint<java.util.Map<?, ?>> VALUE_SIZE = Constraints.sizeMap(1, 10);
